// 🔥 Substitua a seção de imagens por esta com Zoom e Download
        ...
        <div className="relative group">
          ...
          <div className="relative overflow-hidden rounded border group">
            ...
            <div className="absolute bottom-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity flex gap-2">
              <button 
                className="bg-black/50 text-white p-1 rounded hover:bg-black/70 text-xs"
                onClick={(e) => {
                  e.stopPropagation();
                  window.open(visit.photo_before, '_blank');
                }}
              ...
              <button 
                ...
                onClick={(e) => {
                  ...
                  link.download = `antes_${visit.store_name}_${new Date().toISOString().slice(0,10)}.jpg`;
            ...
            <div className="absolute bottom-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity flex gap-2">
              ...
              <button 
                ...
                onClick={(e) => {
                  ...
                  link.download = `depois_${visit.store_name}_${new Date().toISOString().slice(0,10)}.jpg`;
                  document.body.appendChild(link);
                  link.click();
                  document.body.removeChild(link);
                }}
